...
Command::Command()
{
    ...
    addAvailableOption("inputFile", Option(Option::File, "if", "commandMode", "Input file containing the input sequences.", ""));
    addAvailableOption("queryFile", Option(Option::File, "qf", "commandMode", "Query file containing the query sequences.", ""));
    addAvailableOption("outputFile", Option(Option::File, "of", "commandMode", "Output file returned with the output.", ""));
    addAvailableOption("kmerSize", Option(Option::Integer, "k", "commandMode", "K-mers size.", "3"));
    addAvailableOption("maxIncorrectCharactersSize", Option(Option::Integer, "m", "commandMode", "Maximum number of incorrect characters.", "3"));
    addAvailableOption("numberOfHashes", Option(Option::Integer, "nh", "commandMode", "Number of Hash Functions", "50"));
    addCategory("commandMode", "Command Mode");
